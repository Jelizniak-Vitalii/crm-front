...
const navItems = [
  { key: 'dashboard', title: 'Dashboard', href: '/dashboard', icon: 'chart-pie' },
  { key: 'customers', title: 'Customers', href: '/dashboard/*', icon: 'users' },
  { key: 'integrations', title: 'Integrations', href: '/dashboard/*', icon: 'plugs-connected' },
  { key: 'settings', title: 'Settings', href: '/dashboard/*', icon: 'gear-six' },
  { key: 'account', title: 'Account', href: '/dashboard/*', icon: 'user' },
  { key: 'error', title: 'Error', href: '/dashboard/*', icon: 'x-square' },
];
  ...
  return (
    ...
    >
      <Stack spacing={2} sx={{ p: 3 }}>
        <Box component={NavLink} href="dashboard" sx={{ display: 'inline-flex' }}>
...
function renderNavItems({ items = [], pathname }: { items?: never[]; pathname: string }): React.JSX.Element {
